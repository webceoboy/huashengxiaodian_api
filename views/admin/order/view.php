            ...
            <div class="col-xs-12 col-md-6"><?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        ['label' => '物流', 'format' => 'raw', 'value' => function (Order $model) {
                            ...
                            if ($item) return sprintf('%s（<span class="btn btn-xs" data-clipboard-text="%s" style="    text-decoration: underline;    cursor: pointer;">%s</span>）', $item['company'], $item['no'], $item['no']);
                            return '-';
                        }],
                        'vendor',
